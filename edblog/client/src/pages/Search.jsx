...
export default function Search() {
  ...
  return (
    <div className='flex flex-col md:flex-row '>
      <div className=' p-7 border-b md:border-r md:min-h-screen border-gray-100 shadow-lg'>
...
<option value='uncategorized'>Kategorisiz</option>
      ...
      <div className='w-full'>
        <h1 className='text-3xl font-semibold sm:border-b border-gray-100 p-3 mt-5 '>
          Sonuçlar:
        </h1>
        <div className='p-7 flex flex-wrap gap-4'>
          {!loading && posts.length === 0 && (
            <p className='text-xl text-gray-500'>Yazı bulunamadı.</p>
          )}
