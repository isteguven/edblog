...
uploadTask.on(
  ...
  (error) => {
    setImageFileUploadError(
      'Fotoğraf yüklenemedi(Dosya büyüklüğü max. 2MB. olmalı)!'
    );
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4">
        <input  type="file" accept="image/*" onChange={handleImageHandle} ref={filePickerRef} hidden/>
        <div
          className="relative w-32 h-32 self-center cursor-pointer shadow-lg 
